...
See [deploy/README.md](deploy/README.md) for development dependency orchestration, production deployment, Nginx, optional HTTPS, and certificate configuration.
