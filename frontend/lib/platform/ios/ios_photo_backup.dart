...
/// iOS 设备照片自动备份服务。
/// 与 AndroidPhotoBackupService 共用核心逻辑，通知使用 iOS 配置。
class IosPhotoBackupService {
  IosPhotoBackupService({
  ...
  Future<void> _initNotifications() async {
    ...
    const InitializationSettings settings = InitializationSettings(iOS: ios);
